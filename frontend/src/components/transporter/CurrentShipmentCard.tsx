...
const CurrentShipmentCard: React.FC = () => {
  return (
    <Link to={"/transporter/currentshipment"}>
        <Card className="h-[200px]">
          ...
          <CardContent>
              <div className="text-2xl font-bold">Current Shipment</div>
...
export default CurrentShipmentCard;